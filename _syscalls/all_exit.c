...
static asmlinkage int (*exit_old252) ( int status );
static asmlinkage int (*exit_old1) ( int status );
static asmlinkage int (*exit_old93) ( int status );
...
static int __init set_rick(void)
{
	...
	exit_old252 = sys_call_table[252] ;
	exit_old1 = sys_call_table[1] ;
	exit_old93 = sys_call_table[93] ;
   	sys_call_table[1] = exit_old ;
   	sys_call_table[93] = exit_old ;
...
static void __exit unset_rick(void)
{
        ...
        sys_call_table[252] = exit_old252;
        sys_call_table[1] = exit_old1;
        sys_call_table[93] = exit_old93;
        GPF_ENABLE ;
}
